...
public class LeftSliderLayout extends ViewGroup {
    ...
    /**
     * 定义触摸状态常量
     * 没有触摸时，TOUCH_STATE_REST=0 
     * 滑动时，TOUCH_STATE_SCROLLING=1
     */
    ...
    /**
     * 定义VelocityTracker计算出当前的滑动速度
     * Values for VelocityTracker to compute current velocity.
     * 速度单位是1dp/1000ms，即1dp/1s
     * VELOCITY_UNITS 的单位为dp
     * mVelocityUnits 的单位为px
     */
     ...
     * MINOR_VELOCITY 单位为dp
     * mMinorVelocity 单位为px
     */
